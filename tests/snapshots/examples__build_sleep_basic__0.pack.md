...
```mcfunction
execute store result score $20 sleep_basic.reaper_framework.var run data get entity @s Item.tag.AttributeModifiers[0].Amount 1
kill @s
execute as @e[type=marker, tag=reaper_framework.entity_nbt.cloud] if score @s reaper_framework.entity_nbt.cloud = $20 sleep_basic.reaper_framework.var run kill @s
```
...
execute store result score $24 sleep_basic.reaper_framework.var run gamerule doMobLoot
execute if score $24 sleep_basic.reaper_framework.var matches 0 run function sleep_basic:reaper_framework/__internal__/mob_loot_gamerule_error
```
...
```mcfunction
execute store result score $14 sleep_basic.reaper_framework.var run data get storage sleep_basic:reaper_framework.var data[5].v[0] 1
execute store result score $15 sleep_basic.reaper_framework.var run data get storage sleep_basic:reaper_framework.var data[5].v[1] 1
data remove storage sleep_basic:reaper_framework.var data[5].v[0]
execute if score $15 sleep_basic.reaper_framework.var = $14 sleep_basic.reaper_framework.var run function sleep_basic:reaper_framework/__internal__/sleep/0/s_sch
...
execute store result score $17 sleep_basic.reaper_framework.var run data get storage sleep_basic:reaper_framework.var data[11].v[0].ts 1
execute store result score $19 sleep_basic.reaper_framework.var run data get storage sleep_basic:reaper_framework.var data[11].v
execute if score $19 sleep_basic.reaper_framework.var matches 0 run function sleep_basic:reaper_framework/__internal__/sleep/0/e_sch_3
...
function reaper_framework:__internal__/sleep/run_at_ctx
execute at @e[type=marker, tag=reaper_framework.sleep.ctx.target, limit=1] run function sleep_basic:reaper_framework/__internal__/sleep/0/run_at_ctx
execute if score $17 sleep_basic.reaper_framework.var = $16 sleep_basic.reaper_framework.var run function sleep_basic:reaper_framework/__internal__/sleep/0/e_sch
```
...
execute store result score $16 sleep_basic.reaper_framework.var run data get storage sleep_basic:reaper_framework.var data[10].v.ts 1
execute if score $16 sleep_basic.reaper_framework.var = $18 sleep_basic.reaper_framework.var run function sleep_basic:reaper_framework/__internal__/sleep/0/e_sch_2
```
...
execute store result score $21 sleep_basic.reaper_framework.var run data get storage sleep_basic:reaper_framework.var data[17].v.ts 1
execute if score $21 sleep_basic.reaper_framework.var = $22 sleep_basic.reaper_framework.var run function sleep_basic:reaper_framework/__internal__/sleep/1/e_sch_2
```
...
```mcfunction
execute store result score $4 sleep_basic.reaper_framework.var run time query gametime
scoreboard players operation $22 sleep_basic.reaper_framework.var = $4 sleep_basic.reaper_framework.var
scoreboard players remove $22 sleep_basic.reaper_framework.var 40
