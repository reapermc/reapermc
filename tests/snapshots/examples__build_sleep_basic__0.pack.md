...
```mcfunction
execute store result score $16 sleep_basic.reaper_framework.var run data get entity @s Item.tag.AttributeModifiers[0].Amount 1
kill @s
execute as @e[type=marker, tag=reaper_framework.entity_nbt.cloud] if score @s reaper_framework.entity_nbt.cloud = $16 sleep_basic.reaper_framework.var run kill @s
```
...
execute store result score $20 sleep_basic.reaper_framework.var run gamerule doMobLoot
execute if score $20 sleep_basic.reaper_framework.var matches 0 run function sleep_basic:reaper_framework/__internal__/mob_loot_gamerule_error
```
...
```mcfunction
execute store result score $10 sleep_basic.reaper_framework.var run data get storage sleep_basic:reaper_framework.var data[5].v[0] 1
execute store result score $11 sleep_basic.reaper_framework.var run data get storage sleep_basic:reaper_framework.var data[5].v[1] 1
data remove storage sleep_basic:reaper_framework.var data[5].v[0]
execute if score $11 sleep_basic.reaper_framework.var = $10 sleep_basic.reaper_framework.var run function sleep_basic:reaper_framework/__internal__/sleep/0/s_sch
data modify storage sleep_basic:reaper_framework.var data[7].v set from storage sleep_basic:reaper_framework.var data[8].v[0]
data remove storage sleep_basic:reaper_framework.var data[8].v[0]
execute store result score $5 sleep_basic.reaper_framework.var run data get storage sleep_basic:reaper_framework.var data[7].v.dim 1
data modify storage sleep_basic:reaper_framework.var data[4].v set from storage sleep_basic:reaper_framework.var data[7].v
function reaper_framework:__internal__/sleep/run_at_ctx
...
data modify storage sleep_basic:reaper_framework.var data[8].v append from storage sleep_basic:reaper_framework.var data[3].v
execute store result score $4 sleep_basic.reaper_framework.var run time query gametime
data modify storage sleep_basic:reaper_framework.var data[5].v append value 0
execute store result storage sleep_basic:reaper_framework.var data[5].v[-1] int 1 run scoreboard players get $4 sleep_basic.reaper_framework.var
...
```mcfunction
data modify entity @s data.__internal__.sleep_basic.reaper_framework.sleep.0 append from storage sleep_basic:reaper_framework.var data[9].v
```
...
data remove storage sleep_basic:reaper_framework.var data[11].v[0]
execute store result score $13 sleep_basic.reaper_framework.var run data get storage sleep_basic:reaper_framework.var data[11].v[0].ts 1
execute store result score $15 sleep_basic.reaper_framework.var run data get storage sleep_basic:reaper_framework.var data[11].v
execute if score $15 sleep_basic.reaper_framework.var matches 0 run function sleep_basic:reaper_framework/__internal__/sleep/0/e_sch_3
data modify storage sleep_basic:reaper_framework.var data[14].v set from storage sleep_basic:reaper_framework.var data[10].v.ctx
execute store result score $5 sleep_basic.reaper_framework.var run data get storage sleep_basic:reaper_framework.var data[14].v.dim 1
data modify storage sleep_basic:reaper_framework.var data[4].v set from storage sleep_basic:reaper_framework.var data[14].v
function reaper_framework:__internal__/sleep/run_at_ctx
execute at @e[type=marker, tag=reaper_framework.sleep.ctx.target, limit=1] run function sleep_basic:reaper_framework/__internal__/sleep/0/run_at_ctx
execute if score $13 sleep_basic.reaper_framework.var = $12 sleep_basic.reaper_framework.var run function sleep_basic:reaper_framework/__internal__/sleep/0/e_sch
```
...
data modify storage sleep_basic:reaper_framework.var data[11].v set from storage sleep_basic:reaper_framework.var data[2].v
data modify storage sleep_basic:reaper_framework.var data[10].v set from storage sleep_basic:reaper_framework.var data[11].v[0]
execute store result score $12 sleep_basic.reaper_framework.var run data get storage sleep_basic:reaper_framework.var data[10].v.ts 1
execute if score $12 sleep_basic.reaper_framework.var = $14 sleep_basic.reaper_framework.var run function sleep_basic:reaper_framework/__internal__/sleep/0/e_sch_2
```
...
```mcfunction
execute store result score $4 sleep_basic.reaper_framework.var run time query gametime
scoreboard players operation $14 sleep_basic.reaper_framework.var = $4 sleep_basic.reaper_framework.var
scoreboard players remove $14 sleep_basic.reaper_framework.var 40
...
```mcfunction
data modify storage sleep_basic:reaper_framework.var data[10].v set from storage sleep_basic:reaper_framework.var data[12].v
...
data remove storage sleep_basic:reaper_framework.var data[9].v
execute store result score $4 sleep_basic.reaper_framework.var run time query gametime
execute store result storage sleep_basic:reaper_framework.var data[9].v.ts int 1 run scoreboard players get $4 sleep_basic.reaper_framework.var
execute unless entity @e[tag=reaper_framework.sleep.ctx, x=0] run function reaper_framework:__internal__/sleep/create_ctx_marker
execute as @e[tag=reaper_framework.sleep.ctx, x=0] run function reaper_framework:__internal__/sleep/get_world_ctx
data modify storage sleep_basic:reaper_framework.var data[9].v.ctx set from storage sleep_basic:reaper_framework.var data[3].v
...
execute unless entity @e[tag=reaper_framework.sleep.ctx, x=0] run function reaper_framework:__internal__/sleep/create_ctx_marker
execute as @e[tag=reaper_framework.sleep.ctx, x=0] run function reaper_framework:__internal__/sleep/get_world_ctx
data modify storage sleep_basic:reaper_framework.var data[15].v set from storage sleep_basic:reaper_framework.var data[3].v
...
```mcfunction
data modify entity @s data.__internal__.sleep_basic.reaper_framework.sleep.1 set from storage sleep_basic:reaper_framework.var data[16].v
```
...
data modify storage sleep_basic:reaper_framework.var data[19].v set from storage sleep_basic:reaper_framework.var data[17].v.ctx
execute store result score $5 sleep_basic.reaper_framework.var run data get storage sleep_basic:reaper_framework.var data[19].v.dim 1
data modify storage sleep_basic:reaper_framework.var data[4].v set from storage sleep_basic:reaper_framework.var data[19].v
function reaper_framework:__internal__/sleep/run_at_ctx
execute at @e[type=marker, tag=reaper_framework.sleep.ctx.target, limit=1] run function sleep_basic:reaper_framework/__internal__/sleep/1/run_at_ctx
```
...
data modify storage sleep_basic:reaper_framework.var data[17].v set from storage sleep_basic:reaper_framework.var data[2].v
execute store result score $17 sleep_basic.reaper_framework.var run data get storage sleep_basic:reaper_framework.var data[17].v.ts 1
execute if score $17 sleep_basic.reaper_framework.var = $18 sleep_basic.reaper_framework.var run function sleep_basic:reaper_framework/__internal__/sleep/1/e_sch_2
```
...
```mcfunction
execute store result score $4 sleep_basic.reaper_framework.var run time query gametime
scoreboard players operation $18 sleep_basic.reaper_framework.var = $4 sleep_basic.reaper_framework.var
scoreboard players remove $18 sleep_basic.reaper_framework.var 40
...
```mcfunction
execute if entity @s[type=!marker, tag=!reaper_framework.entity_nbt.user] run function reaper_framework:__internal__/entity_nbt/ensure_entry
data remove storage sleep_basic:reaper_framework.var data[16].v
execute store result score $4 sleep_basic.reaper_framework.var run time query gametime
execute store result storage sleep_basic:reaper_framework.var data[16].v.ts int 1 run scoreboard players get $4 sleep_basic.reaper_framework.var
execute unless entity @e[tag=reaper_framework.sleep.ctx, x=0] run function reaper_framework:__internal__/sleep/create_ctx_marker
execute as @e[tag=reaper_framework.sleep.ctx, x=0] run function reaper_framework:__internal__/sleep/get_world_ctx
data modify storage sleep_basic:reaper_framework.var data[16].v.ctx set from storage sleep_basic:reaper_framework.var data[3].v
