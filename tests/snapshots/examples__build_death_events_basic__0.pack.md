...
execute store result score $14 death_events_basic.reaper_framework.var run gamerule doMobLoot
execute if score $14 death_events_basic.reaper_framework.var matches 0 run function death_events_basic:reaper_framework/__internal__/mob_loot_gamerule_error
```
