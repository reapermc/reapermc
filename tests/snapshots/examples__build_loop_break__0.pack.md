...
```mcfunction
scoreboard players set $8 reaper.var 2
scoreboard players set $9 reaper.var 0
scoreboard players operation $3 reaper.var = $9 reaper.var
function loop_break:reaper_framework/loop/0
execute unless score $8 reaper.var matches 0 run function loop_break:reaper_framework/__internal__/loop/cache/0_srv_cycle
```
...
```mcfunction
scoreboard players set $13 reaper.var 2
scoreboard players set $14 reaper.var 0
scoreboard players operation $3 reaper.var = $14 reaper.var
function loop_break:reaper_framework/loop/1
execute unless score $13 reaper.var matches 0 run function loop_break:reaper_framework/__internal__/loop/cache/1_srv_cycle
```
...
```mcfunction
data remove storage reaper:var data[6].v[0]
scoreboard players remove $19 reaper.var 1
...
execute store result storage reaper:var data[6].v[-1] int 1 run scoreboard players get $19 reaper.var
...
```mcfunction
scoreboard players set $19 reaper.var 2
data modify storage reaper:var data[7].v append value 0
scoreboard players set $3 reaper.var 0
function loop_break:reaper_framework/loop/2
execute unless score $19 reaper.var matches 0 run function demo:main/nested_execute_8
```
...
```mcfunction
data remove storage reaper:var data[13].v[0]
scoreboard players remove $29 reaper.var 1
...
execute store result storage reaper:var data[13].v[-1] int 1 run scoreboard players get $29 reaper.var
...
```mcfunction
scoreboard players set $29 reaper.var 2
data modify storage reaper:var data[14].v append value 0
scoreboard players set $3 reaper.var 0
function loop_break:reaper_framework/loop/3
execute unless score $29 reaper.var matches 0 run function demo:main/nested_execute_16
```
...
scoreboard players add $9 reaper.var 1
scoreboard players operation $3 reaper.var = $9 reaper.var
function loop_break:reaper_framework/loop/0
execute unless score $8 reaper.var matches 0 run function loop_break:reaper_framework/__internal__/loop/cache/0_srv_cycle
```
...
```mcfunction
scoreboard players set $8 reaper.var 0
```
...
execute store result score $10 reaper.var run data get storage reaper:var data[2].v.ts 1
execute if score $10 reaper.var = $11 reaper.var run function loop_break:reaper_framework/__internal__/sleep/1_ent_2
```
...
scoreboard players operation $11 reaper.var = $0 reaper.var
scoreboard players remove $11 reaper.var 20
...
```mcfunction
execute store result score $15 reaper.var run data get storage reaper:var data[3].v.dim 1
execute as @e[tag=reaper.sleep.ctx] if score $15 reaper.var = @s reaper.sleep.dim_id run function loop_break:reaper_framework/__internal__/sleep/2_srv_1
...
```mcfunction
scoreboard players remove $13 reaper.var 1
scoreboard players add $14 reaper.var 1
scoreboard players operation $3 reaper.var = $14 reaper.var
function loop_break:reaper_framework/loop/1
execute unless score $13 reaper.var matches 0 run function loop_break:reaper_framework/__internal__/loop/cache/1_srv_cycle
```
...
```mcfunction
scoreboard players set $13 reaper.var 0
```
...
execute store result score $18 reaper.var run data get storage reaper:var data[5].v.dim 1
execute as @e[tag=reaper.sleep.ctx] if score $18 reaper.var = @s reaper.sleep.dim_id run function loop_break:reaper_framework/__internal__/sleep/3_ent_3
...
execute store result score $16 reaper.var run data get storage reaper:var data[4].v.ts 1
execute if score $16 reaper.var = $17 reaper.var run function loop_break:reaper_framework/__internal__/sleep/3_ent_2
```
...
```mcfunction
execute store result score $0 reaper.var run time query gametime
scoreboard players operation $17 reaper.var = $0 reaper.var
scoreboard players remove $17 reaper.var 15
...
```mcfunction
execute store result score $21 reaper.var run data get storage reaper:var data[8].v[0] 1
execute store result score $22 reaper.var run data get storage reaper:var data[8].v[1] 1
data remove storage reaper:var data[8].v[0]
function loop_break:reaper_framework/sleep/4
execute if score $22 reaper.var = $21 reaper.var run function loop_break:reaper_framework/__internal__/sleep/4_srv_sch
```
...
```mcfunction
execute store result score $19 reaper.var run data get storage reaper:var data[6].v[0] 1
execute if score $19 reaper.var matches 0 run function demo:main/nested_execute_6
execute unless score $19 reaper.var matches 0 run function demo:main/nested_execute_7
```
...
execute store result score $25 reaper.var run data get storage reaper:var data[11].v[0].ts 1
execute store result score $27 reaper.var run data get storage reaper:var data[11].v
execute if score $27 reaper.var matches 0 run function loop_break:reaper_framework/__internal__/sleep/5_ent_3
function loop_break:reaper_framework/sleep/5
execute if score $25 reaper.var = $24 reaper.var run function loop_break:reaper_framework/__internal__/sleep/5_ent_sch
```
...
execute store result score $24 reaper.var run data get storage reaper:var data[12].v.ts 1
execute if score $24 reaper.var = $26 reaper.var run function loop_break:reaper_framework/__internal__/sleep/5_ent_2
```
...
```mcfunction
execute store result score $0 reaper.var run time query gametime
scoreboard players operation $26 reaper.var = $0 reaper.var
scoreboard players remove $26 reaper.var 15
...
```mcfunction
execute store result score $31 reaper.var run data get storage reaper:var data[15].v[0] 1
execute store result score $32 reaper.var run data get storage reaper:var data[15].v[1] 1
...
execute store result score $33 reaper.var run data get storage reaper:var data[16].v.dim 1
execute as @e[tag=reaper.sleep.ctx] if score $33 reaper.var = @s reaper.sleep.dim_id run function loop_break:reaper_framework/__internal__/sleep/6_srv_1
execute at @e[tag=reaper.sleep.ctx.target] run function loop_break:reaper_framework/__internal__/sleep/6_srv_2
execute if score $32 reaper.var = $31 reaper.var run function loop_break:reaper_framework/__internal__/sleep/6_srv_sch
```
...
```mcfunction
execute store result score $29 reaper.var run data get storage reaper:var data[13].v[0] 1
execute if score $29 reaper.var matches 0 run function demo:main/nested_execute_14
execute unless score $29 reaper.var matches 0 run function demo:main/nested_execute_15
```
...
execute store result score $35 reaper.var run data get storage reaper:var data[20].v[0].ts 1
execute store result score $37 reaper.var run data get storage reaper:var data[20].v
execute if score $37 reaper.var matches 0 run function loop_break:reaper_framework/__internal__/sleep/7_ent_3
data modify storage reaper:var data[18].v set from storage reaper:var data[21].v.ctx
execute store result score $38 reaper.var run data get storage reaper:var data[18].v.dim 1
execute as @e[tag=reaper.sleep.ctx] if score $38 reaper.var = @s reaper.sleep.dim_id run function loop_break:reaper_framework/__internal__/sleep/7_ent_4
execute at @e[tag=reaper.sleep.ctx.target] run function loop_break:reaper_framework/__internal__/sleep/7_ent_5
execute if score $35 reaper.var = $34 reaper.var run function loop_break:reaper_framework/__internal__/sleep/7_ent_sch
```
...
execute store result score $34 reaper.var run data get storage reaper:var data[21].v.ts 1
execute if score $34 reaper.var = $36 reaper.var run function loop_break:reaper_framework/__internal__/sleep/7_ent_2
```
...
```mcfunction
execute store result score $0 reaper.var run time query gametime
scoreboard players operation $36 reaper.var = $0 reaper.var
scoreboard players remove $36 reaper.var 15
