...
```mcfunction
execute unless score $17 kill_basic.reaper_framework.var = $17 kill_basic.reaper_framework.var store result score $17 kill_basic.reaper_framework.var run seed
```
...
scoreboard players set $19 kill_basic.reaper_framework.var 1630111353
scoreboard players set $20 kill_basic.reaper_framework.var 1623164762
scoreboard players set $21 kill_basic.reaper_framework.var 2147483647
function reaper_framework:__internal__/math/random/init
forceload add 0 0
