...
```mcfunction
say hello
scoreboard players operation $0 reaper.var = $demo demo
scoreboard players add $0 reaper.var 10
function time_basic:reaper_framework/__internal__/set_time/start
execute store result score $0 reaper.var run time query daytime
scoreboard players operation $demo demo = $0 reaper.var
```

### time_basic

`@function time_basic:reaper_framework/__internal__/spark/on_join`

```mcfunction
scoreboard players set @s reaper.spark 0
function time_basic:reaper_framework/spark/prejoin
function time_basic:reaper_framework/spark/join
function time_basic:reaper_framework/spark/postjoin
```

`@function time_basic:reaper_framework/__internal__/spark/init`
...
function time_basic:reaper_framework/spark/preload
function time_basic:reaper_framework/spark/load
function time_basic:reaper_framework/spark/postload
function time_basic:reaper_framework/__internal__/spark/clock
```

`@function time_basic:reaper_framework/__internal__/spark/clock`

```mcfunction
schedule function time_basic:reaper_framework/__internal__/spark/clock 1
execute as @a if score @s reaper.spark matches 1.. at @s run function time_basic:reaper_framework/__internal__/spark/on_join
function time_basic:reaper_framework/spark/pretick
function time_basic:reaper_framework/spark/tick
function time_basic:reaper_framework/spark/posttick
```

`@function time_basic:reaper_framework/spark/prejoin`

```mcfunction
function time_basic:reaper_framework/__internal__/sleep/onjoin_flush
function time_basic:reaper_framework/__internal__/loop/onjoin_flush
```
...
scoreboard objectives add demo dummy {"text": "demo", "color": "gold"}
```

`@function time_basic:reaper_framework/better_summon/0`
...
`@function time_basic:reaper_framework/__internal__/object/garbage_collector`
...
`@function time_basic:reaper_framework/object/remove_entity`
...
`@function time_basic:reaper_framework/__internal__/object/ensure_entry`
...
execute as @e[type=minecraft:marker, tag=reaper.summon.init] at @s run function time_basic:reaper_framework/better_summon/0
...
```mcfunction
execute as @e[type=item, nbt={Item: {tag: {reaper.object.death_cleanup: 1b}}}] run function time_basic:reaper_framework/__internal__/object/garbage_collector
execute as @e[type=item] if data entity @s {Item: {tag: {reaper.death_event: 1b}}} at @s run function time_basic:reaper_framework/__internal__/death_events/get_item_info
```

`@function time_basic:reaper_framework/__internal__/death_events/get_item_info`

```mcfunction
execute store result score $find reaper.death_events run data get entity @s Item.tag.AttributeModifiers[0].Amount
kill @s
function time_basic:reaper_framework/__internal__/death_events/find_event
```

`@function time_basic:reaper_framework/__internal__/set_time/32768`

```mcfunction
scoreboard players remove $0 reaper.var 32768
time add 32768
```
...
```mcfunction
scoreboard players remove $0 reaper.var 16384
time add 16384
```
...
```mcfunction
scoreboard players remove $0 reaper.var 8192
time add 8192
```
...
```mcfunction
scoreboard players remove $0 reaper.var 4096
time add 4096
```
...
```mcfunction
scoreboard players remove $0 reaper.var 2048
time add 2048
```
...
```mcfunction
scoreboard players remove $0 reaper.var 1024
time add 1024
```
...
```mcfunction
scoreboard players remove $0 reaper.var 512
time add 512
```
...
```mcfunction
scoreboard players remove $0 reaper.var 256
time add 256
```
...
```mcfunction
scoreboard players remove $0 reaper.var 128
time add 128
```
...
```mcfunction
scoreboard players remove $0 reaper.var 64
time add 64
```
...
```mcfunction
scoreboard players remove $0 reaper.var 32
time add 32
```
...
```mcfunction
scoreboard players remove $0 reaper.var 16
time add 16
```
...
```mcfunction
scoreboard players remove $0 reaper.var 8
time add 8
```
...
```mcfunction
scoreboard players remove $0 reaper.var 4
time add 4
```
...
```mcfunction
scoreboard players remove $0 reaper.var 2
time add 2
```
...
```mcfunction
scoreboard players remove $0 reaper.var 1
time add 1
```
...
```mcfunction
time set 0
execute if score $0 reaper.var matches 32768.. run function time_basic:reaper_framework/__internal__/set_time/32768
execute if score $0 reaper.var matches 16384.. run function time_basic:reaper_framework/__internal__/set_time/16384
execute if score $0 reaper.var matches 8192.. run function time_basic:reaper_framework/__internal__/set_time/8192
execute if score $0 reaper.var matches 4096.. run function time_basic:reaper_framework/__internal__/set_time/4096
execute if score $0 reaper.var matches 2048.. run function time_basic:reaper_framework/__internal__/set_time/2048
execute if score $0 reaper.var matches 1024.. run function time_basic:reaper_framework/__internal__/set_time/1024
execute if score $0 reaper.var matches 512.. run function time_basic:reaper_framework/__internal__/set_time/512
execute if score $0 reaper.var matches 256.. run function time_basic:reaper_framework/__internal__/set_time/256
execute if score $0 reaper.var matches 128.. run function time_basic:reaper_framework/__internal__/set_time/128
execute if score $0 reaper.var matches 64.. run function time_basic:reaper_framework/__internal__/set_time/64
execute if score $0 reaper.var matches 32.. run function time_basic:reaper_framework/__internal__/set_time/32
execute if score $0 reaper.var matches 16.. run function time_basic:reaper_framework/__internal__/set_time/16
execute if score $0 reaper.var matches 8.. run function time_basic:reaper_framework/__internal__/set_time/8
execute if score $0 reaper.var matches 4.. run function time_basic:reaper_framework/__internal__/set_time/4
execute if score $0 reaper.var matches 2.. run function time_basic:reaper_framework/__internal__/set_time/2
execute if score $0 reaper.var matches 1.. run function time_basic:reaper_framework/__internal__/set_time/1
```
...
{
  "values": [
    "time_basic:reaper_framework/__internal__/spark/init"
  ]
}
```
