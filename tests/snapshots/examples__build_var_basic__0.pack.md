...
```mcfunction
data modify storage reaper:var data[2].v set value 10
scoreboard players set $8 reaper.var 69
```

### var_basic

`@function var_basic:reaper_framework/__internal__/spark/on_join`

```mcfunction
scoreboard players set @s reaper.spark 0
function var_basic:reaper_framework/spark/prejoin
function var_basic:reaper_framework/spark/join
function var_basic:reaper_framework/spark/postjoin
```

`@function var_basic:reaper_framework/__internal__/spark/init`
...
function var_basic:reaper_framework/spark/preload
function var_basic:reaper_framework/spark/load
function var_basic:reaper_framework/spark/postload
function var_basic:reaper_framework/__internal__/spark/clock
```

`@function var_basic:reaper_framework/__internal__/spark/clock`

```mcfunction
schedule function var_basic:reaper_framework/__internal__/spark/clock 1
execute as @a if score @s reaper.spark matches 1.. at @s run function var_basic:reaper_framework/__internal__/spark/on_join
function var_basic:reaper_framework/spark/pretick
function var_basic:reaper_framework/spark/tick
function var_basic:reaper_framework/spark/posttick
```

`@function var_basic:reaper_framework/spark/prejoin`

```mcfunction
function var_basic:reaper_framework/__internal__/sleep/onjoin_flush
function var_basic:reaper_framework/__internal__/loop/onjoin_flush
```

`@function var_basic:reaper_framework/spark/preload`

```mcfunction
function var_basic:reaper_framework/__internal__/scoreboard/init
function var_basic:reaper_framework/__internal__/scoreboard/init_defaults
function var_basic:reaper_framework/__internal__/var/flush_memory
function var_basic:reaper_framework/__internal__/var/init_defaults
```
...
`@function var_basic:reaper_framework/better_summon/0`
...
`@function var_basic:reaper_framework/__internal__/object/garbage_collector`
...
`@function var_basic:reaper_framework/object/remove_entity`
...
`@function var_basic:reaper_framework/__internal__/object/ensure_entry`
...
execute as @e[type=minecraft:marker, tag=reaper.summon.init] at @s run function var_basic:reaper_framework/better_summon/0
...
```mcfunction
execute as @e[type=item, nbt={Item: {tag: {reaper.object.death_cleanup: 1b}}}] run function var_basic:reaper_framework/__internal__/object/garbage_collector
execute as @e[type=item] if data entity @s {Item: {tag: {reaper.death_event: 1b}}} at @s run function var_basic:reaper_framework/__internal__/death_events/get_item_info
```

`@function var_basic:reaper_framework/__internal__/death_events/get_item_info`

```mcfunction
execute store result score $find reaper.death_events run data get entity @s Item.tag.AttributeModifiers[0].Amount
kill @s
function var_basic:reaper_framework/__internal__/death_events/find_event
```
...
{
  "values": [
    "var_basic:reaper_framework/__internal__/spark/init"
  ]
}
```
