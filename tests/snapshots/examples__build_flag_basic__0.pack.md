...
```mcfunction
execute store result score $8 reaper.var if predicate flag_basic:reaper_framework/__internal__/flag/is_in_air
execute if score $8 reaper.var matches 1 run say in air
execute if score $8 reaper.var matches 0 run say not in air
execute store result score $8 reaper.var if predicate flag_basic:reaper_framework/__internal__/flag/is_holding_netherite_axe
execute if score $8 reaper.var matches 1 run tellraw @s {"text": "True", "color": "gold"}
execute if score $8 reaper.var matches 0 run tellraw @s {"text": "False", "color": "gold"}
```

### flag_basic

`@function flag_basic:reaper_framework/__internal__/spark/on_join`

```mcfunction
scoreboard players set @s reaper.spark 0
function flag_basic:reaper_framework/spark/prejoin
function flag_basic:reaper_framework/spark/join
function flag_basic:reaper_framework/spark/postjoin
```

`@function flag_basic:reaper_framework/__internal__/spark/init`
...
function flag_basic:reaper_framework/spark/preload
function flag_basic:reaper_framework/spark/load
function flag_basic:reaper_framework/spark/postload
function flag_basic:reaper_framework/__internal__/spark/clock
```

`@function flag_basic:reaper_framework/__internal__/spark/clock`

```mcfunction
schedule function flag_basic:reaper_framework/__internal__/spark/clock 1
execute as @a if score @s reaper.spark matches 1.. at @s run function flag_basic:reaper_framework/__internal__/spark/on_join
function flag_basic:reaper_framework/spark/pretick
function flag_basic:reaper_framework/spark/tick
function flag_basic:reaper_framework/spark/posttick
```

`@function flag_basic:reaper_framework/spark/prejoin`

```mcfunction
function flag_basic:reaper_framework/__internal__/sleep/onjoin_flush
function flag_basic:reaper_framework/__internal__/loop/onjoin_flush
```
...
`@function flag_basic:reaper_framework/better_summon/0`
...
`@function flag_basic:reaper_framework/__internal__/object/garbage_collector`
...
`@function flag_basic:reaper_framework/object/remove_entity`
...
`@function flag_basic:reaper_framework/__internal__/object/ensure_entry`
...
execute as @e[type=minecraft:marker, tag=reaper.summon.init] at @s run function flag_basic:reaper_framework/better_summon/0
...
```mcfunction
execute as @e[type=item, nbt={Item: {tag: {reaper.object.death_cleanup: 1b}}}] run function flag_basic:reaper_framework/__internal__/object/garbage_collector
execute as @e[type=item] if data entity @s {Item: {tag: {reaper.death_event: 1b}}} at @s run function flag_basic:reaper_framework/__internal__/death_events/get_item_info
```

`@function flag_basic:reaper_framework/__internal__/death_events/get_item_info`

```mcfunction
execute store result score $find reaper.death_events run data get entity @s Item.tag.AttributeModifiers[0].Amount
kill @s
function flag_basic:reaper_framework/__internal__/death_events/find_event
```
...
`@predicate flag_basic:reaper_framework/__internal__/flag/is_in_air`
...
`@predicate flag_basic:reaper_framework/__internal__/flag/is_holding_netherite_axe`
...
{
  "values": [
    "flag_basic:reaper_framework/__internal__/spark/init"
  ]
}
```
