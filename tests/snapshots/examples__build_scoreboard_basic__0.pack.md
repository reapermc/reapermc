...
```mcfunction
scoreboard players set $bar fooscb 123
```

### scoreboard_basic

`@function scoreboard_basic:reaper_framework/__internal__/spark/on_join`

```mcfunction
scoreboard players set @s reaper.spark 0
function scoreboard_basic:reaper_framework/spark/prejoin
function scoreboard_basic:reaper_framework/spark/join
function scoreboard_basic:reaper_framework/spark/postjoin
```

`@function scoreboard_basic:reaper_framework/__internal__/spark/init`
...
function scoreboard_basic:reaper_framework/spark/preload
function scoreboard_basic:reaper_framework/spark/load
function scoreboard_basic:reaper_framework/spark/postload
function scoreboard_basic:reaper_framework/__internal__/spark/clock
```

`@function scoreboard_basic:reaper_framework/__internal__/spark/clock`

```mcfunction
schedule function scoreboard_basic:reaper_framework/__internal__/spark/clock 1
execute as @a if score @s reaper.spark matches 1.. at @s run function scoreboard_basic:reaper_framework/__internal__/spark/on_join
function scoreboard_basic:reaper_framework/spark/pretick
function scoreboard_basic:reaper_framework/spark/tick
function scoreboard_basic:reaper_framework/spark/posttick
```

`@function scoreboard_basic:reaper_framework/spark/prejoin`

```mcfunction
function scoreboard_basic:reaper_framework/__internal__/sleep/onjoin_flush
function scoreboard_basic:reaper_framework/__internal__/loop/onjoin_flush
```
...
scoreboard objectives add fooscb dummy {"text": "fooscb", "color": "gold"}
```

`@function scoreboard_basic:reaper_framework/better_summon/0`
...
`@function scoreboard_basic:reaper_framework/__internal__/object/garbage_collector`
...
`@function scoreboard_basic:reaper_framework/object/remove_entity`
...
`@function scoreboard_basic:reaper_framework/__internal__/object/ensure_entry`
...
execute as @e[type=minecraft:marker, tag=reaper.summon.init] at @s run function scoreboard_basic:reaper_framework/better_summon/0
...
```mcfunction
execute as @e[type=item, nbt={Item: {tag: {reaper.object.death_cleanup: 1b}}}] run function scoreboard_basic:reaper_framework/__internal__/object/garbage_collector
execute as @e[type=item] if data entity @s {Item: {tag: {reaper.death_event: 1b}}} at @s run function scoreboard_basic:reaper_framework/__internal__/death_events/get_item_info
```

`@function scoreboard_basic:reaper_framework/__internal__/death_events/get_item_info`

```mcfunction
execute store result score $find reaper.death_events run data get entity @s Item.tag.AttributeModifiers[0].Amount
kill @s
function scoreboard_basic:reaper_framework/__internal__/death_events/find_event
```
...
{
  "values": [
    "scoreboard_basic:reaper_framework/__internal__/spark/init"
  ]
}
```
