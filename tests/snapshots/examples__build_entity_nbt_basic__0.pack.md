...
execute store result score $14 entity_nbt_basic.reaper_framework.var run data get storage entity_nbt_basic:reaper_framework.var data[2].v 1
```
...
```mcfunction
execute store result score $15 entity_nbt_basic.reaper_framework.var run data get entity @s Item.tag.AttributeModifiers[0].Amount 1
kill @s
execute as @e[type=marker, tag=reaper_framework.entity_nbt.cloud] if score @s reaper_framework.entity_nbt.cloud = $15 entity_nbt_basic.reaper_framework.var run kill @s
```
...
execute store result score $16 entity_nbt_basic.reaper_framework.var run gamerule doMobLoot
execute if score $16 entity_nbt_basic.reaper_framework.var matches 0 run function entity_nbt_basic:reaper_framework/__internal__/mob_loot_gamerule_error
```
