...
```mcfunction
execute unless score $17 event_basic3.reaper_framework.var = $17 event_basic3.reaper_framework.var store result score $17 event_basic3.reaper_framework.var run seed
```
...
scoreboard players set $19 event_basic3.reaper_framework.var 1630111353
scoreboard players set $20 event_basic3.reaper_framework.var 1623164762
scoreboard players set $21 event_basic3.reaper_framework.var 2147483647
function reaper_framework:__internal__/math/random/init
forceload add 0 0
...
execute store result score $26 event_basic3.reaper_framework.var run gamerule doMobLoot
execute if score $26 event_basic3.reaper_framework.var matches 0 run function event_basic3:reaper_framework/__internal__/mob_loot_gamerule_error
```
