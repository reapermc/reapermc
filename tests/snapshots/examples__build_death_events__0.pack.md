...
execute as @e[type=minecraft:sheep, tag=reaper.summon.init] at @s run function death_events:reaper_framework/better_summon/1
```

### death_events

`@function death_events:reaper_framework/__internal__/spark/on_join`

```mcfunction
scoreboard players set @s reaper.spark 0
function death_events:reaper_framework/spark/prejoin
function death_events:reaper_framework/spark/join
function death_events:reaper_framework/spark/postjoin
```

`@function death_events:reaper_framework/__internal__/spark/init`
...
function death_events:reaper_framework/spark/preload
function death_events:reaper_framework/spark/load
function death_events:reaper_framework/spark/postload
function death_events:reaper_framework/__internal__/spark/clock
```

`@function death_events:reaper_framework/__internal__/spark/clock`

```mcfunction
schedule function death_events:reaper_framework/__internal__/spark/clock 1
execute as @a if score @s reaper.spark matches 1.. at @s run function death_events:reaper_framework/__internal__/spark/on_join
function death_events:reaper_framework/spark/pretick
function death_events:reaper_framework/spark/tick
function death_events:reaper_framework/spark/posttick
```

`@function death_events:reaper_framework/spark/prejoin`

```mcfunction
function death_events:reaper_framework/__internal__/sleep/onjoin_flush
function death_events:reaper_framework/__internal__/loop/onjoin_flush
```

`@function death_events:reaper_framework/spark/preload`

```mcfunction
function death_events:reaper_framework/__internal__/scoreboard/init
function death_events:reaper_framework/__internal__/scoreboard/init_defaults
function death_events:reaper_framework/__internal__/var/flush_memory
function death_events:reaper_framework/__internal__/var/init_defaults
```
...
`@function death_events:reaper_framework/better_summon/0`
...
`@function death_events:reaper_framework/__internal__/object/garbage_collector`
...
`@function death_events:reaper_framework/object/remove_entity`
...
`@function death_events:reaper_framework/__internal__/object/ensure_entry`
...
execute as @e[type=minecraft:marker, tag=reaper.summon.init] at @s run function death_events:reaper_framework/better_summon/0
...
```mcfunction
execute as @e[type=item, nbt={Item: {tag: {reaper.object.death_cleanup: 1b}}}] run function death_events:reaper_framework/__internal__/object/garbage_collector
execute as @e[type=item] if data entity @s {Item: {tag: {reaper.death_event: 1b}}} at @s run function death_events:reaper_framework/__internal__/death_events/get_item_info
```

`@function death_events:reaper_framework/__internal__/death_events/get_item_info`

```mcfunction
execute store result score $find reaper.death_events run data get entity @s Item.tag.AttributeModifiers[0].Amount
kill @s
function death_events:reaper_framework/__internal__/death_events/find_event
```

`@function death_events:reaper_framework/death_events/0`
...
`@function death_events:reaper_framework/better_summon/1`

```mcfunction
tag @s add reaper.death_event
scoreboard players set @s reaper.death_events 0
tag @s remove reaper.summon.init
```
...
```mcfunction
execute if score $find reaper.death_events matches 0 run function death_events:reaper_framework/death_events/0
```
...
{
  "values": [
    "death_events:reaper_framework/__internal__/spark/init"
  ]
}
```
