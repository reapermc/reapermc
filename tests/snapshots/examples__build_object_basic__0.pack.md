...
```mcfunction
summon sheep ~ ~ ~ {Tags: ["reaper.summon.init"]}
execute as @e[type=minecraft:sheep, tag=reaper.summon.init] at @s run function object_basic:reaper_framework/better_summon/1
```

### object_basic

`@function object_basic:reaper_framework/__internal__/spark/on_join`

```mcfunction
scoreboard players set @s reaper.spark 0
function object_basic:reaper_framework/spark/prejoin
function object_basic:reaper_framework/spark/join
function object_basic:reaper_framework/spark/postjoin
```

`@function object_basic:reaper_framework/__internal__/spark/init`
...
function object_basic:reaper_framework/spark/preload
function object_basic:reaper_framework/spark/load
function object_basic:reaper_framework/spark/postload
function object_basic:reaper_framework/__internal__/spark/clock
```

`@function object_basic:reaper_framework/__internal__/spark/clock`

```mcfunction
schedule function object_basic:reaper_framework/__internal__/spark/clock 1
execute as @a if score @s reaper.spark matches 1.. at @s run function object_basic:reaper_framework/__internal__/spark/on_join
function object_basic:reaper_framework/spark/pretick
function object_basic:reaper_framework/spark/tick
function object_basic:reaper_framework/spark/posttick
```

`@function object_basic:reaper_framework/spark/prejoin`

```mcfunction
function object_basic:reaper_framework/__internal__/sleep/onjoin_flush
function object_basic:reaper_framework/__internal__/loop/onjoin_flush
```

`@function object_basic:reaper_framework/spark/preload`

```mcfunction
function object_basic:reaper_framework/__internal__/scoreboard/init
function object_basic:reaper_framework/__internal__/scoreboard/init_defaults
function object_basic:reaper_framework/__internal__/var/flush_memory
function object_basic:reaper_framework/__internal__/var/init_defaults
```
...
`@function object_basic:reaper_framework/better_summon/0`
...
`@function object_basic:reaper_framework/__internal__/object/garbage_collector`
...
`@function object_basic:reaper_framework/object/remove_entity`
...
`@function object_basic:reaper_framework/__internal__/object/ensure_entry`
...
execute as @e[type=minecraft:marker, tag=reaper.summon.init] at @s run function object_basic:reaper_framework/better_summon/0
...
```mcfunction
execute as @e[type=item, nbt={Item: {tag: {reaper.object.death_cleanup: 1b}}}] run function object_basic:reaper_framework/__internal__/object/garbage_collector
execute as @e[type=item] if data entity @s {Item: {tag: {reaper.death_event: 1b}}} at @s run function object_basic:reaper_framework/__internal__/death_events/get_item_info
```

`@function object_basic:reaper_framework/__internal__/death_events/get_item_info`

```mcfunction
execute store result score $find reaper.death_events run data get entity @s Item.tag.AttributeModifiers[0].Amount
kill @s
function object_basic:reaper_framework/__internal__/death_events/find_event
```

`@function object_basic:reaper_framework/__internal__/object/cache/0_1`

```mcfunction
data modify entity @s data.stats set value {iq: 30}
```

`@function object_basic:reaper_framework/__internal__/object/cache/0_0`

```mcfunction
execute if entity @s at @s as @e[type=marker, tag=reaper.object.m] if score @s reaper.object.m = @e[tag=reaper.object.holder, sort=nearest, limit=1] reaper.object run function object_basic:reaper_framework/__internal__/object/cache/0_1
```

`@function object_basic:reaper_framework/better_summon/1`

```mcfunction
execute if entity @s unless entity @s[tag=reaper.object.holder] run function object_basic:reaper_framework/__internal__/object/ensure_entry
function object_basic:reaper_framework/__internal__/object/cache/0_0
tag @s remove reaper.summon.init
```
...
{
  "values": [
    "object_basic:reaper_framework/__internal__/spark/init"
  ]
}
```
